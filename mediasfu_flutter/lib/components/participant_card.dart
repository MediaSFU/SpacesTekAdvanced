...
class _ParticipantCardState extends State<ParticipantCard> {
  ...
  void didUpdateWidget(covariant ParticipantCard oldWidget) {
    ...
    // If the videoStream changed, create or dispose the renderer as needed
  ...
  void _createRendererIfNeeded(MediaStream? stream) async {
    if (stream == null) return;

    // If we previously disposed the renderer, or haven't created one yet, create it
    ...
    // If the widget is unmounted during async, skip
    if (!mounted) return;
  ...
  void _disposeRenderer() {
    // If it’s already disposed, no-op
