...
import {
  // MediasfuGeneric,
  PreJoinPage, Credentials, CreateMediaSFURoomOptions, CreateJoinRoomError, CreateJoinRoomResponse, CreateJoinRoomType, JoinMediaSFURoomOptions } from 'mediasfu-angular';
import { MediasfuGenericAlt } from '../custom/mediasfu-generic-alt.component';
...
@Component({
  ...
  imports: [CommonModule, MediasfuGenericAlt],
})
